...
@override
String toString() {
  return 'AppUser(id: $id, email: $email, displayName: $displayName, photoUrl: $photoUrl, isAdmin: $isAdmin)';
}
...
class _AppUser extends AppUser {
  const _AppUser({required this.id, required this.email, this.displayName, this.photoUrl, this.isAdmin = false}): super._();
